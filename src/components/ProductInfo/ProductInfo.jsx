...
export default function ProductInfo({ nombre, id, precio, stock, categoria, descripcion, ubicacion, metrosCuadrados, dormitorios, banios, ambientes, subcategoria, zona, hectareas, img1, img2, img3, img4, img5, img6, img7, }) {
          ...
          <div className="infoPayment">
            ...
            {categoria === 'urbanas' && (
              <div className="paymentMethods">
                <div className="paymentItem"><BorderOuterIcon /><span>{metrosCuadrados}m^2</span></div>
            ...
            {categoria === 'rurales' && (
              <div className="paymentMethods">
                <div className="paymentItem"><BorderOuterIcon /><span>{hectareas}Ha</span></div>
